...
# ==============================================================================
# IMPORTANT:
# PASTE THE URLs GENERATED BY THE `upload_assets.py`  SCRIPT IN THIS DICTIONARY
# ==============================================================================
ASSET_URLS = {
    "server/phylum_classifier_model.pkl": "https://etugragppltlnp2x.public.blob.vercel-storage.com/server/phylum_classifier_model.pkl",
    "models/trained_models.pkl": "https://etugragppltlnp2x.public.blob.vercel-storage.com/models/trained_models.pkl",
    "models/processed_data.pkl": "https://etugragppltlnp2x.public.blob.vercel-storage.com/models/processed_data.pkl",
    "models/combined_features.npy": "https://etugragppltlnp2x.public.blob.vercel-storage.com/models/combined_features.npy",
    "test_models/trained_models.pkl": "https://etugragppltlnp2x.public.blob.vercel-storage.com/test_models/trained_models.pkl",
    "test_models/processed_data.pkl": "https://etugragppltlnp2x.public.blob.vercel-storage.com/test_models/processed_data.pkl",
    "test_models/combined_features.npy": "https://etugragppltlnp2x.public.blob.vercel-storage.com/test_models/combined_features.npy",
    "dataset/18S_unfiltered_table_excel_with_taxonomy.csv": "https://etugragppltlnp2x.public.blob.vercel-storage.com/dataset/18S_unfiltered_table_excel_with_taxonomy.csv",
    "dataset/cox1_unfiltered_table_excel_with_taxonomy.csv": "https://etugragppltlnp2x.public.blob.vercel-storage.com/dataset/cox1_unfiltered_table_excel_with_taxonomy.csv",
    "dataset/Annelida/bold_data.csv": "https://etugragppltlnp2x.public.blob.vercel-storage.com/dataset/Annelida/bold_data.csv",
    "dataset/Annelida/fasta.fas": "https://etugragppltlnp2x.public.blob.vercel-storage.com/dataset/Annelida/fasta.fas",
    "dataset/anthropoda/bold_data.csv": "https://etugragppltlnp2x.public.blob.vercel-storage.com/dataset/anthropoda/bold_data.csv",
    "dataset/anthropoda/fasta.fas": "https://etugragppltlnp2x.public.blob.vercel-storage.com/dataset/anthropoda/fasta.fas",
    "dataset/Chordata/bold_data.csv": "https://etugragppltlnp2x.public.blob.vercel-storage.com/dataset/Chordata/bold_data.csv",
    "dataset/Chordata/fasta.fas": "https://etugragppltlnp2x.public.blob.vercel-storage.com/dataset/Chordata/fasta.fas",
    "dataset/Cnidaria/bold_data.csv": "https://etugragppltlnp2x.public.blob.vercel-storage.com/dataset/Cnidaria/bold_data.csv",
    "dataset/Cnidaria/fasta.fas": "https://etugragppltlnp2x.public.blob.vercel-storage.com/dataset/Cnidaria/fasta.fas",
    "dataset/Echinodermata/bold_data.csv": "https://etugragppltlnp2x.public.blob.vercel-storage.com/dataset/Echinodermata/bold_data.csv",
    "dataset/Echinodermata/fasta.fas": "https://etugragppltlnp2x.public.blob.vercel-storage.com/dataset/Echinodermata/fasta.fas",
    "dataset/mollusca/bold_data.csv": "https://etugragppltlnp2x.public.blob.vercel-storage.com/dataset/mollusca/bold_data.csv",
    "dataset/mollusca/fasta.fas": "https://etugragppltlnp2x.public.blob.vercel-storage.com/dataset/mollusca/fasta.fas",
    "dataset/Porifera/bold_data.csv": "https://etugragppltlnp2x.public.blob.vercel-storage.com/dataset/Porifera/bold_data.csv",
    "dataset/Porifera/fasta.fas": "https://etugragppltlnp2x.public.blob.vercel-storage.com/dataset/Porifera/fasta.fas",
}

# --- Helper function to download and load assets from Vercel Blob ---
def load_asset_from_url(asset_path):
    normalized_path = os.path.normpath(asset_path).replace("\\", "/")
    url = ASSET_URLS.get(normalized_path)

    if not url or url == "PASTE_YOUR_URL_HERE":
        raise ValueError(f"URL for asset '{normalized_path}' is missing in ASSET_URLS.")

    print(f"Loading {normalized_path} from URL...")
    response = requests.get(url, timeout=30)
    response.raise_for_status()

    asset_file = io.BytesIO(response.content)

    if normalized_path.endswith('.pkl'):
        return joblib.load(asset_file)
    elif normalized_path.endswith('.npy'):
        return np.load(asset_file)
    elif normalized_path.endswith(('.csv', '.fas')):
        return asset_file.read().decode('utf-8')
    else:
        return asset_file.read()

class eDNAPipeline:
    def __init__(self):
        print("Initializing eDNAPipeline by loading models from Vercel Blob...")
        self.phylum_model = load_asset_from_url("server/phylum_classifier_model.pkl")
        self.processed_data = load_asset_from_url("models/processed_data.pkl")
        self.trained_models = load_asset_from_url("models/trained_models.pkl")
        self.combined_features = load_asset_from_url("models/combined_features.npy")
        print("eDNAPipeline initialized successfully.")

    def get_taxonomic_classification(self, dna_sequence):
        try:
            if self.phylum_model:
                 phylum_prediction = "Chordata (Mock Prediction from loaded model)"
            else:
                 phylum_prediction = "Error: Model not loaded"

            return {
                "phylum": phylum_prediction,
                "class": "Mammalia", "order": "Primates", "family": "Hominidae",
                "genus": "Homo", "species": "Homo sapiens"
            }
        except Exception as e:
            print(f"Error during prediction: {e}")
            return {"error": "Failed to classify sequence."}
